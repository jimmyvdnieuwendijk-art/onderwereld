...
export function RegisterForm() {
  ...
  return (
    <AuthShell
      ...
      description="Kies een straatnaam. Je start als Scum in Amsterdam (Schiphol) met €500 cash."
      footer={
        <>
          Al een account?{" "}
    ...
    >
      <form action={action} className="space-y-4">
        <div className="space-y-2">
          ...
          <Input id="username" name="username" required minLength={3} maxLength={16} placeholder="straatnaam" />
        </div>
        <div className="space-y-2">
